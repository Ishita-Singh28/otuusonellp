...
// import styles from './NewWorkAbout.module.scss'
...
// import ResponsiveAbout from './ResponsiveAbout/ResponsiveAbout'
...
//     return (
//         <Grid className={styles.newWorkAboutContainer}>
//             <Typography variant='h5' fontSize={21} fontWeight={600}>Key people</Typography>
//             <Typography variant='h4' fontSize={16} fontWeight={400}>At OTUSONE, our key people are the driving force behind our success. Meet the leaders shaping our vision and guiding our journey.</Typography>
//             <Grid container className={styles.newWorkAbout}>
//                 <Grid item sm={7} className={styles.newWorkAboutImg}>
//                     <img alt='' src={img1} width={91} height={100} onClick={() => handleImageClick("Akanksha Singh")} className={selectedImg === "Akanksha Singh" ? styles.animate1 : ""} />
//                     <img alt='' src={img2} width={91} height={100} onClick={() => handleImageClick("Aparna Singh")} className={selectedImg === "Aparna Singh" ? styles.animate5 : ""} />
//                     <img alt='' src={img6} width={91} height={100} onClick={() => handleImageClick("Ankit Singh")} className={selectedImg === "Ankit Singh" ? styles.animate3 : ""} />
//                     <img alt='' src={img3} width={91} height={100} onClick={() => handleImageClick("Aman Shukla")} className={selectedImg === "Aman Shukla" ? styles.animate2 : ""} />
//                     <img alt='' src={img4} width={91} height={100} onClick={() => handleImageClick("Narendra Singh")} className={selectedImg === "Narendra Singh" ? styles.animate4 : ""} />
//                     <img alt=''src={img5} width={91} height={100} onClick={() => handleImageClick("Abhishek Mishra")} className={selectedImg === "Abhishek Mishra" ? styles.animate6 : ""} />
...
//                 </Grid>
//             </Grid>
//             <Grid className={styles.responsiveAbout}>
//                 <ResponsiveAbout />
//             </Grid>
//         </Grid>
//     )
...
const NewWorkAbout = () => {
    ...
    return (
        <Grid className={styles.newWorkAboutContainer}>
            ...
            <Grid container className={styles.newWorkAbout}>
                <Grid item sm={7} className={styles.newWorkAboutImg}>
                    <img alt='' src={img1} width={71} height={80} onClick={() => handleImageClick("MERN")} className={selectedImg === "MERN" ? styles.animate1 : ""} />
                    <img alt='' src={img2} width={71} height={80} onClick={() => handleImageClick("WordPress")} className={selectedImg === "WordPress" ? styles.animate5 : ""} />
                    <img alt='' src={img6} width={71} height={80} onClick={() => handleImageClick("Android App")} className={selectedImg === "Android App" ? styles.animate3 : ""} />
                    <img alt='' src={img3} width={71} height={80} onClick={() => handleImageClick("MEAN")} className={selectedImg === "MEAN" ? styles.animate2 : ""} />
                    <img alt='' src={img4} width={71} height={80} onClick={() => handleImageClick("Flutter")} className={selectedImg === "Flutter" ? styles.animate4 : ""} />
                    <img alt='' src={img5} width={71} height={80} onClick={() => handleImageClick("React Native")} className={selectedImg === "React Native" ? styles.animate6 : ""} />
                    <Grid className={styles.bgStyle}>
                    </Grid>
                </Grid>
